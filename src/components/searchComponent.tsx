...
const SearchComponent = () => {
  return (
    <div className="relative w-auto max-w-full h-[130px] mt-[25px] ml-[250px] mr-11 pr-4 bg-pink-500 rounded-t-lg top-0 opacity-90">
      ...
      <div className="relative z-10 p-4 flex flex-col gap-2 h-full">
        ...
        <div className="w-full max-w-full flex items-center bg-white rounded-lg shadow-lg">
