...
>
  <div className="flex flex-col">
    ...
    <div className="flex justify-between items-center py-2 border-b mb-2 px-10">
      <span className="text-xl  font-bold text-black w-[15%]">Service Name</span>
      <span className="text-xl font-bold text-black w-[15%]">Amenities</span>
      <span className="text-xl font-bold text-black w-[15%]">Service Price</span>
      <span className="text-xl font-bold text-black w-[20%]">Required Therapists</span>
    ...
    {amenities.map((amenity, index) => (
      <div key={index} className="flex justify-between items-center py-2 border-b mb-4 px-10">
        <span className="text-lg text-black w-[15%]">{amenity.serviceName}</span>
        <span className="text-lg text-black w-[15%]">
          {amenity.amenities.map((item) => item.name).join(', ')}
        </span>
        <span className="text-lg text-black w-[15%] ml-1">{amenity.servicePrice}</span>
        <span className="text-lg text-black ml-1 w-[20%]">{amenity.requiredTherapist}</span>
